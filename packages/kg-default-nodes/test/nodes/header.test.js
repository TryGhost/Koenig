    ...
    describe('v2', function () {
        ...
        describe('exportDOM', function () {
            it('renders version 2 html', editorTest(function () {
                ...
                const expectedHtml = `
                <div class="kg-card kg-header-card kg-v2 kg-width-full " style=";" data-background-color="#F0F0F0">
                <picture><img class="kg-header-card-image" src="https://example.com/image.jpg" alt=""></picture>
                    <div class="kg-header-card-content">
                        <div class="kg-header-card-text kg-align-center">
            ...
            it('renders without subheader', editorTest(function () {
                ...
                const renderedHtml = _.replace(element.outerHTML, /\s/g, '');
                const expectedHtml = `
                <div class="kg-card kg-header-card kg-v2 kg-width-full " style="background-color: #000000;" data-background-color="#000000">
                    <div class="kg-header-card-content">
                        <div class="kg-header-card-text kg-align-center">
