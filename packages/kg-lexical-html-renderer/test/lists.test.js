...
describe('Lists', function () {
    ...
    it('ul > ul', shouldRender({
        ...
        output: '<ul><li>one</li><li><ul><li>two.one</li><li>two.two</li></ul></li><li>three</li></ul>'
    }));
    ...
    it('ol > ol', shouldRender({
        ...
        output: '<ol><li>one</li><li><ol><li>two.one</li><li>two.two</li></ol></li><li>three</li></ol>'
    }));
    ...
    it('ul > ol', shouldRender({
        ...
        output: '<ul><li>one</li><li><ol><li>two.one</li><li>two.two</li></ol></li><li>three</li></ul>'
    }));
    ...
    it('ul > ol > ul', shouldRender({
        ...
        output: '<ul><li>one</li><li><ol><li>two.one</li><li><ul><li>three.one</li><li>three.two</li></ul></li><li>two.three</li></ol></li><li>three</li></ul>'
    }));
    ...
    it('ol > ul > ol', shouldRender({
        ...
        output: '<ol><li>one</li><li><ul><li>two.one</li><li><ol><li>three.one</li><li>three.two</li></ol></li><li>two.three</li></ul></li><li>three</li></ol>'
    }));
