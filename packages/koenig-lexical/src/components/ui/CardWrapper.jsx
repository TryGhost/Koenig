...
export const CardWrapper = React.forwardRef(({isSelected, cardWidth, cardType, children, ...props}, ref) => {
    return (
        <div
            className={`relative border border-transparent caret-grey-800 ${isSelected ? 'shadow-[0_0_0_2px] shadow-green' : 'hover:shadow-[0_0_0_1px] hover:shadow-green'} ${(cardWidth === 'wide') ? 'mx-[calc(50%-(50vw-.8rem)] w-[calc(65vw+2px)] min-w-[calc(100%+3.6rem)] sm:min-w-[calc(100%+10rem)] lg:min-w-[calc(100%+18rem)] translate-x-[calc(50vw-50%+.8rem)]' : (cardWidth === 'full') ? 'mx-[calc(50%-50vw)] w-[100vw]' : ''}`}
            ref={ref}
