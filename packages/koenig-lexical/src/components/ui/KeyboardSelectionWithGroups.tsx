...
export function KeyboardSelectionWithGroups<T extends GroupItem>({groups, getItem, getGroup, onSelect, defaultSelected, isLoading}: KeyboardSelectionWithGroupsProps<T>) {
