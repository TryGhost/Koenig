    ...
    return (
        <div className="not-kg-prose min-h-[170px]">
            ...
            <input
                ...
                className={`z-999 absolute right-1.5 top-1.5 w-1/5 rounded border border-grey-300 py-1 px-2 font-sans text-[1.3rem] leading-4 text-grey-900 transition-opacity focus-visible:outline-none dark:border-grey-900 dark:text-grey-400 ${showLanguage ? 'opacity-100' : 'opacity-0'}`}
