            ...
            editor.registerCommand(
                ...
                (event: KeyboardEvent) => {
                    ...
                    if (event.key === ':') {
                        ...
                        // only swallow the closing colon when there's an exact shortcode match
                        const emojiMatch = searchResults?.[0];
                        if (!emojiMatch || emojiMatch.id !== queryString) {
                            return false;
                        }
                        handleCompletionInsertion(emojiMatch);
