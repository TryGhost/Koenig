const defaultTheme = {
    ...
    atLink: 'inline-flex items-center bg-grey-200/70 mx-[-.2rem] px-1 pb-[.2rem] leading-[1.4] rounded dark:bg-grey-950',
    atLinkSearch: 'after:content-[attr(data-placeholder)] after:text-grey-500 dark:after:text-grey-600 min-w-[5px]',
    atLinkIcon: 'px-1 text-grey-600 dark:text-grey-500'
};
