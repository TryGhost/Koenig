// @ts-expect-error no types for fs-extra
...
test.describe('Image card', async () => {
    ...
    test.skip('can paste html to caption', async function () {
        ...
        await page.click('[data-testid="image-caption-editor"]');
        await pasteHtml(page, 'This is link <a href="https://ghost.org/changelog/markdown/">ghost.org/changelog/markdown/</a>');
...
async function mockTenorApi(page: Page, {status} = {status: 200}) {
...
async function mockKlipyApi(page: Page, {status} = {status: 200}) {
