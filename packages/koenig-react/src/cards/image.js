    ...
    return (
        ...
        >
            <div className='__mobiledoc-card' contentEditable="false">
                <img src={props?.src || `https://images.unsplash.com/photo-1524612219806-a2423c90e45e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80`} alt={props?.alt || 'image alt description'} />
            </div>
        </Card>
    );
};
